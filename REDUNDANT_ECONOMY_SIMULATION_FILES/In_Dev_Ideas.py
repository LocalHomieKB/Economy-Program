...
Weighted variable values, the directness of impact:
1000 can represent the base weighted value figure of variable importance.
Anything else less important goes below this.
...
Yearly mortality rate calculated based on real life UK mortality statistics.
Split into elderly death and health related death.
Done by splitting the difference of 2/3 of 0.5 million deaths a year being elderly.
The other side being health related.
"""
